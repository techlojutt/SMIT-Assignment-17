export const blogData =[
    {
      cardImage: require("../assets/blog-1.png"),
      topic: 'Database',
    ...
    {
     cardImage: require("../assets/blog-2.png"),
     ...
     authorDetail: {
        ...
        {
          cardImage: require("../assets/blog-3.png"),
          topic: 'Accessibility',
        ...
        {
          cardImage: require("../assets/blog-4.png"),
          topic: 'Database',
        ...
        {
          cardImage: require("../assets/blog-5.png"),
          topic: 'Web Performance',
          title: 'Adaptive Loading - Improving Web Performance on low-end devices',
          description: 'Adaptive Loading: Do not just respond based on screen size, adapt based on actual device hardware. Any user can have a slow experience. In a world with widely varying device capabilities, a "one-size" fits all experience may not always work.',
          authorDetail: {
            image: require("../assets/author.png"),
            name: 'Julia Walker',
            date: 'Nov 10, 2021',
        ...
        {
          cardImage: require("../assets/blog-6.png"),
          topic: 'Accessibility',
        ...
        {
          cardImage: require("../assets/blog-7.png"),
          topic: 'Database',
        ...
        {
          cardImage: require("../assets/blog-8.png"),
          topic: 'Web Performance',
        ...
        {
          cardImage: require("../assets/blog-9.png"),
          topic: 'Accessibility',
        ...
        {
          cardImage: require("../assets/blog-10.png"),
          topic: 'Database',
